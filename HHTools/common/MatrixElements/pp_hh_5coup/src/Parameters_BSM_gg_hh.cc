...
// Constructor
Parameters_BSM_gg_hh::Parameters_BSM_gg_hh(const SLHA::Reader& card) 
{
...
m_card_parameters["mdl_cy"] = card.get_block_entry("bsm", 189, 1.000000e+00); 
m_card_parameters["mdl_ctr"] = card.get_block_entry("bsm", 188, 1.000000e+00); 
m_card_parameters["mdl_a2"] = card.get_block_entry("bsm", 32, 1.000000e+00); 
m_card_parameters["mdl_a1"] = card.get_block_entry("bsm", 31, 1.000000e+00); 
m_card_parameters["mdl_c2"] = card.get_block_entry("bsm", 30, -1.000000e+00); 

this->cacheParameters(); 
this->cacheCouplings(); 
}

void Parameters_BSM_gg_hh::cacheParameters()
{
// Define "zero"
zero = 0; 
ZERO = 0; 
...
mdl_cy = m_card_parameters["mdl_cy"]; 
mdl_ctr = m_card_parameters["mdl_ctr"]; 
mdl_a2 = m_card_parameters["mdl_a2"]; 
mdl_a1 = m_card_parameters["mdl_a1"]; 
mdl_c2 = m_card_parameters["mdl_c2"]; mdl_MZ__exp__2 = ((mdl_MZ) * (mdl_MZ)); 
mdl_MZ__exp__4 = ((mdl_MZ) * (mdl_MZ) * (mdl_MZ) * (mdl_MZ)); 
mdl_sqrt__2 = sqrt(2.); 
mdl_MH__exp__2 = ((mdl_MH) * (mdl_MH)); 
mdl_complexi = std::complex<double> (0., 1.); 
mdl_cy__exp__2 = ((mdl_cy) * (mdl_cy)); 
mdl_aEW = 1./aEWM1; 
...
void Parameters_BSM_gg_hh::cacheCouplings()
{
GC_28 = -6. * mdl_complexi * mdl_lam * mdl_vev * mdl_ctr; 
}

void Parameters_BSM_gg_hh::updateParameters()
{
...
void Parameters_BSM_gg_hh::updateCouplings()
{
...
GC_36 = -mdl_c2 * (aS * mdl_complexi)/(3. * M_PI * mdl_vev__exp__2) * (-3./2.); 
}
