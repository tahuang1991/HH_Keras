...
C     P(1,2)*P(2,1) - P(-1,1)*P(-1,2)*Metric(1,2)
C     
      SUBROUTINE VVSS2_3_4_5_0
     & (V1, V2, S3, S4,COUP1,COUP2,COUP3,COUP4,VERTEX)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 V2(*)
      ...
      COMPLEX*16 COUP1
      COMPLEX*16 COUP2
      COMPLEX*16 COUP3,COUP4
      COMPLEX*16 VERTEX
      COMPLEX*16 TMP, TMP2, TMP4
      COMPLEX*16 V1(*)
      COMPLEX*16 S4(*)
      CALL VVSS2_0(V1,V2,S3,S4,COUP1,VERTEX)
      CALL VVSS3_0(V1,V2,S3,S4,COUP2,TMP)
      CALL VVSS4_0(V1,V2,S3,S4,COUP3,TMP2)
      CALL VVSS5_0(V1,V2,S3,S4,COUP4,TMP4)

      VERTEX = VERTEX + TMP + TMP2 + TMP4
      END
